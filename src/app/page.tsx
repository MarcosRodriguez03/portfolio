        ...
        <section>
          <div className="max-w-[1100px] mx-auto">
            ...
            <div className=" grid grid-cols-4">
              ...
              <div className="w-48 h-16 bg-slate-900 m-6 rounded-[10px] flex items-center px-4 ">
                <img className="w-[48px] h-[48px]" alt="Html" src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/html5/html5-plain.svg" />
                <p className="text-[20px] ml-4 text-white">HTML</p>
              </div>
              ...
              <div className="w-48 h-16 bg-slate-900 m-6 rounded-[10px] flex items-center px-4 ">
                ...
                <p className="text-[20px] ml-4 text-white">TypeScript</p>
              </div>
              ...
              <div className="w-48 h-16 bg-slate-900 m-6 rounded-[10px] flex items-center px-4 ">
                ...
                <p className="text-[20px] ml-4 text-white">C#</p>
              </div>
              ...
              <div className="w-48 h-16 bg-slate-900 m-6 rounded-[10px] flex items-center px-4 ">
                ...
                <p className="text-[20px] ml-4 text-white">SQL</p>
              </div>
              ...
              <div className="w-48 h-16 bg-slate-900 m-6 rounded-[10px] flex items-center px-4 ">
                ...
                <p className="text-[20px] ml-4 text-white">React</p>
              </div>
              ...
              <div className="w-48 h-16 bg-slate-900 m-6 rounded-[10px] flex items-center px-4 ">
                ...
                <p className="text-[20px] ml-4 text-white">NextJS</p>
              </div>
              ...
              <div className="w-48 h-16 bg-slate-900 m-6 rounded-[10px] flex items-center px-4 ">
                ...
                <p className="text-[20px] ml-4 text-white">Tailwind</p>
              </div>
              ...
              <div className="w-48 h-16 bg-slate-900 m-6 rounded-[10px] flex items-center px-4 ">
                ...
                <p className="text-[20px] ml-4 text-white">BootStrap</p>
              </div>
              ...
              <div className="w-48 h-16 bg-slate-900 m-6 rounded-[10px] flex items-center px-4 ">
                ...
                <p className="text-[20px] ml-4 text-white">Angular</p>
              </div>
              ...
              <div className="w-48 h-16 bg-slate-900 m-6 rounded-[10px] flex items-center px-4 ">
                ...
                <p className="text-[20px] ml-4 text-white">.NET</p>
              </div>
              ...
              <div className="w-48 h-16 bg-slate-900 m-6 rounded-[10px] flex items-center px-4 ">
                ...
                <p className="text-[20px] ml-4 text-white">Figma</p>
              </div>
              ...
              <div className="w-48 h-16 bg-slate-900 m-6 rounded-[10px] flex items-center px-4 ">
                ...
                <p className="text-[20px] ml-4 text-white">Github</p>
              </div>
              ...
              <div className="w-48 h-16 bg-slate-900 m-6 rounded-[10px] flex items-center px-4 ">
                ...
                <p className="text-[20px] ml-4 text-white">Notion</p>
              </div>
              ...
              <div className="w-48 h-16 bg-slate-900 m-6 rounded-[10px] flex items-center px-4 ">
                ...
                <p className="text-[20px] ml-4 text-white">Slack</p>
              </div>
              ...
              <div className="w-48 h-16 bg-slate-900 m-6 rounded-[10px] flex items-center px-4 ">
                ...
                <p className="text-[20px] ml-4 text-white">Azure</p>
              </div>
              ...
              <div className="w-48 h-16 bg-slate-900 m-6 rounded-[10px] flex items-center px-4 ">
                ...
                <p className="text-[20px] ml-4 text-white">Vercel</p>
              </div>
